        ...
        headers: [
          ...
          // CSP
          {
            ...
            value:
              ...
              `connect-src 'self' ${BACKEND} https://api.pinata.cloud https://gateway.pinata.cloud https://fonts.reown.com https://api.web3modal.org https://registry.npmjs.org https://pulse.walletconnect.org https://verify.walletconnect.org https://api.reown.com https://explorer-api.walletconnect.com https://rpc.walletconnect.org wss://relay.walletconnect.org wss://*.walletconnect.org; ` +
  ...
  webpack: (config, { isServer }) => {
    ...
    config.optimization.splitChunks = {
      ...
      cacheGroups: {
        ...
        appkit: { test: /[\\/]node_modules[\\/]@reown[\\/]/, name: "appkit", chunks: "all", priority: 10 },
      },
    };
    return config;
  },

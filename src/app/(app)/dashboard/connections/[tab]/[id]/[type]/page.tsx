      ...
      {userFollow.length > 0 &&
        userFollow.map((user) => (
          ...
          >
            ...
            {/* hover part */}
            <div className="absolute z-50 left-1/2 -translate-x-1/2 top-[calc(100%+10px)] w-[420px] rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] shadow-2xl p-4">

    ...
    <div className="px-4 md:pl-72 md:pr-8 pt-24 pb-10">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-white/[0.02] to-white/5 backdrop-blur-sm p-8 mb-8 shadow-2xl">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400">Your personal details and account information</p>
            </div>
          </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-4">
                  <h2 className="text-3xl font-bold text-white">{user.display_name || user.username || 'Your name'}</h2>
                  {user?.role && (
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    <p className="text-gray-200 leading-relaxed">
                      {user.bio || 'No bio added yet. Visit the Personal page to add a short description about yourself.'}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {user.last_login && (
                    <div className="space-y-2">
                      ...
                      <p className="text-white text-sm">{new Date(user.last_login).toLocaleString()}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          ...
          <p className="text-white font-medium">2 connected</p>
          <p className="text-xs text-gray-400 mt-1">MetaMask, Ledger</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-400 mt-1">Last: MacBook Pro</p>
        </div>
